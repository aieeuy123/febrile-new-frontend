...
export default function ItemCarousel({id="",img="",type="",title=""}){
          ...
          <>
               <div className="hidden md:block">
                    <Link to={`${type}/${id}/`} className="block w-96 rounded-2xl image_">
                         ...
                         <div className="w-full h-full">
                              <h1 className="absolute bottom-0 p-2 py-10 text-lg font-semibold text-white shadow-lg">{title}</h1>
               ...
               <div className="block md:hidden">
                    <Link to={`${type}/${id}/`} className="block rounded-2xl image_" style={{height:"36vh",width:"90vw"}}>
                         ...
                         <div className="w-full h-full">
                               <h1 className="absolute p-1 text-lg font-medium text-gray-200 shadow-lg bottom-2 ">{title}</h1>
